    ...
    const notifications = [
        {
            ...
            title: "'React Performance' session is live now!",
            desc: "Arjun M. just started the live session you registered for.",
            time: "2 mins ago",
            unread: true,
            action: "Join Session",
            href: "/sessions/1",
        },
        {
            ...
            desc: "You've been consistently learning for a whole week. Keep it up!",
            time: "3 hours ago",
            unread: true,
            action: "View Profile",
            href: "/profile",
        },
        {
            ...
            title: "New Post in 'Full Stack Dev Hub'",
            desc: "Someone shared a new project looking for code reviews.",
            time: "5 hours ago",
            unread: false,
        },
        {
            ...
            desc: "Your PR '#42 Update Auth Logic' was approved in the CodeSphere OSS workspace.",
            time: "1 day ago",
            unread: false,
            action: "View PR",
            href: "/codex/1",
        ...
        <div className="p-6 md:p-8 max-w-4xl mx-auto w-full space-y-6">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-2">
                <div>
                    ...
                    <p className="text-muted-foreground">Catch up on all your alerts, messages, and updates.</p>
                </div>
            ...
            <Card className="border-border/40 bg-card/50">
                <CardContent className="p-0 divide-y divide-border/40">
                    {notifications.map((n) => (
                        <div key={n.id} className={`p-5 flex gap-4 transition-colors hover:bg-muted/30 ${n.unread ? "bg-muted/10" : ""}`}>
                            ...
                            <div className="flex-1 min-w-0">
                                <div className="flex sm:items-center justify-between gap-2 flex-col sm:flex-row mb-1">
                                    <h3 className={`text-base font-semibold ${n.unread ? "text-foreground" : "text-foreground/80"}`}>
                                        {n.title}
                                    </h3>
