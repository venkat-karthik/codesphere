...
import { MessageSquare, Users, Heart, Share2, MoreVertical, Maximize, Mic, Video as VideoIcon, Settings, ChevronDown, Hand } from "lucide-react";
            ...
            <div className="flex-1 flex max-w-[1800px] w-full mx-auto overflow-hidden">
                ...
                <div className="flex-1 lg:w-3/4 flex flex-col min-w-0 bg-black relative border-r border-border/40">
                    ...
                    <div className="flex-1 relative flex items-center justify-center overflow-hidden">
                        {/* Gradient Background mimicking stream */}
                        ...
                        <div className="absolute bottom-6 right-6 w-64 aspect-video bg-zinc-800 rounded-lg border-2 border-white/10 shadow-2xl overflow-hidden flex items-center justify-center z-10">
                            <div className="text-xs text-white/50 absolute bottom-2 left-2 font-mono">Arjun M.</div>
                            <Avatar className="w-12 h-12 border-2 border-primary">
                                <AvatarFallback className="bg-primary/20 text-white">AM</AvatarFallback>
                            </Avatar>
                        </div>
                        ...
                        <div className="w-[85%] aspect-video bg-gray-900 border border-white/10 rounded-lg shadow-2xl z-0 flex flex-col !overflow-hidden relative">
                            ...
                            <div className="flex-1 p-6 font-mono text-sm text-green-400 bg-[#1e1e1e]">
                                ...
                                &nbsp;&nbsp;&nbsp;&nbsp;<span className="text-gray-500">// Expensive calculation here...</span><br />
                        ...
                        <div className="absolute top-6 left-6 flex items-center gap-3 z-10">
                            ...
                            <Badge variant="outline" className="bg-black/50 backdrop-blur-md border-white/10 text-white">
                                <Users className="w-3.5 h-3.5 mr-1" /> 1,204
                            </Badge>
                        </div>
                    </div>
                    ...
                    <div className="h-20 bg-zinc-950 border-t border-white/10 px-6 flex items-center justify-between shrink-0">
                        <div>
                            <h2 className="text-white font-semibold text-lg hover:underline cursor-pointer">React Performance Deep Dive</h2>
                            <p className="text-white/60 text-sm">Advanced Frontend Architecture Series</p>
                        </div>
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <Button variant="ghost" size="icon" className="text-white/70 hover:text-white hover:bg-white/10 rounded-full h-10 w-10 ml-2">
                ...
                <div className="w-80 lg:w-96 bg-card flex flex-col shrink-0 hidden md:flex">
                    ...
                    {/* Chat Messages */}
                    <div className="flex-1 overflow-y-auto p-4 space-y-4 font-sm">
                        {[
                            ...
                            { u: "TechLead", m: "Wait, does memoizing the array actually prevent the re-render if the props change?", c: "text-orange-400" },
                        ...
                        <div className="text-center my-4 opacity-50 text-xs text-muted-foreground bg-muted/30 py-1 rounded inline-block mx-auto px-3 flex justify-center w-full">2 new messages</div>
                    </div>
                    ...
                    <div className="p-4 border-t border-border/40 bg-card/50 shrink-0">
                        <div className="flex items-center gap-2">
                            ...
                            <input
                                ...
                                className="flex-1 bg-muted/50 border border-border/40 rounded-full px-4 py-2 text-sm focus:outline-none focus:ring-1 focus:ring-primary text-foreground placeholder:text-muted-foreground"
                            />
                            <Button size="icon" className="w-9 h-9 shrink-0 rounded-full bg-primary hover:bg-primary/90 text-primary-foreground">
