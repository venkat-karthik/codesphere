...
export function Sidebar({ currentSection, onAuthModalOpen, mobileOpen, onMobileClose }: SidebarProps) {
  ...
  const sections = [
    ...
    { title: 'Learn', items: [
      ...
      { id: 'resources' as Section, icon: FileText, label: 'Resources', path: '/learning/resources' },
    ...
    { title: 'Engage', items: [
      ...
      { id: 'video-call' as Section, icon: VideoCallIcon, label: 'Video Call', path: '/video-call' },
    ]},
    { title: 'Tools', items: [
      { id: 'mentor' as Section, icon: Bot, label: 'AI Mentor', path: '/mentor' },
      { id: 'store' as Section, icon: Store, label: 'CodeCoin Store', path: '/store' },
    ]},
    { title: 'Account', items: [
